(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mongodb-adapter"] = factory();
	else
		root["mongodb-adapter"] = factory();
...
var Event = /*#__PURE__*/function () {
  ...
  function Event(data) {
    ...
    _defineProperty(this, "transaction_hash", void 0);

    _defineProperty(this, "block_number", void 0);

    _defineProperty(this, "log_index", void 0);

    _defineProperty(this, "tx_index", void 0);

    _defineProperty(this, "from_address", void 0);

    _defineProperty(this, "global_index", void 0);

    _defineProperty(this, "block_timestamp", void 0);

    _defineProperty(this, "args", void 0);

    _defineProperty(this, "processed_subscribers", void 0);
...
;// CONCATENATED MODULE: ./src/lib/models/QueueEvent.js



var QueueEvent = /*#__PURE__*/function () {
  /**
   * @type {string}
   */
   ...
   * @type {string}
   */
  function QueueEvent(event, subscriber) {
    _classCallCheck(this, QueueEvent);

    _defineProperty(this, "id", void 0);

    _defineProperty(this, "event_id", void 0);
...
var MongoDBAdapter = /*#__PURE__*/function () {
  ...
  function MongoDBAdapter(db) {
    ...
    _defineProperty(this, "events_queue", null);

    _defineProperty(this, "subscribers", null);

    _defineProperty(this, "client", null);

    _defineProperty(this, "db", null);

    _defineProperty(this, "_is_chainsyncer_adapter", true);
  ...
  _createClass(MongoDBAdapter, [{
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.latest_blocks.findOne({
              ...
              case 2:
                ...
                return _context.abrupt("return", item.block_number);
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return this.events_queue.deleteMany({
                  event: {
                    $in: events.map(function (n) {
                      return n.split(".")[1];
                    })
                  },
                  contract: {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                unprocessed_events = _context3.sent.filter(function (n) {
                  return !n.processed_subscribers[subscriber];
                }).map(function (n) {
                  return new QueueEvent(_objectSpread2({
                    id: n._id
                  }, n), subscriber);
                });
                _context3.next = 5;
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this.subscribers.find({}).toArray();

              case 2:
                subscribers = _context4.sent;
                return _context4.abrupt("return", subscribers);
    ...
    value: function () {
      var _updateSubscriber = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(subscriberName, events) {
        var subscriber, latest_blocks, events_added, events_removed;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                ...
                _context5.next = 7;
                return this.latest_blocks.find({}).toArray();

              case 7:
                latest_blocks = _context5.sent.map(function (n) {
                  return _defineProperty({}, n.contract_name, n.block_number);
                });
                _context5.next = 10;
                return this.subscribers.insertOne({
                  name: subscriberName,
                  events: [],
                  added_at: _toConsumableArray(latest_blocks)
                });
              ...
              case 13:
                events_added = events.filter(function (n) {
                  return !subscriber.events.includes(n);
                });
                events_removed = subscriber.events.filter(function (n) {
                  return !events.includes(n);
                });
                _context5.next = 17;
                return this.subscribers.updateOne({
                  name: subscriberName
                }, {
                  $set: {
                    events: events
        ...
        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return this.latest_blocks.updateOne({
                  contract_name: contract_name
                }, {
                  $set: {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this.events_queue.find({
                  subscriber: subscriber
                }).toArray();

              case 2:
                from_queue = _context7.sent.map(function (n) {
                  return n.event_id;
                });
                _context7.next = 5;
                return this.events.find({
            ...
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                return this.events.updateOne({
                  ...
                  $set: {
                    processed_subscribers: item.processed_subscribers
                  }
                });

              case 7:
                __id = id + "_" + subscriber;
                _context8.next = 10;
                return this.events_queue.deleteOne({
                  _id: __id
                });
        ...
        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              ...
              case 2:
                exist_ids = _context9.sent.map(function (n) {
                  return n._id;
                });
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 2:
                ...
                _context11.next = 5;
                return this.filterExistingEvents(events.map(function (n) {
                  return n.id;
                }));

              case 5:
                non_exist_ids = _context11.sent;
              ...
              case 8:
                _context11.next = 10;
                return this.events.insertMany(events.map(function (n) {
                  return n.toMongoObject();
                }));

              case 10:
                _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop(i) {
                  var subs, filtered_events;
                  return _regeneratorRuntime().wrap(function _loop$(_context10) {
                    while (1) {
                      switch (_context10.prev = _context10.next) {
                        case 0:
                          subs = subscribers[i];
                          filtered_events = events.filter(function (n) {
                ...
                _context11.t0 = _regeneratorRuntime().keys(subscribers);
...
//# sourceMappingURL=mongodb-adapter.umd.js.map